 ...
 */ !(function () {
  ...
  function i() {
    function e(e) {
      ...
      var A,
        ...
        a =
          ...
          (i.onCustomMessage = function (e) {
            return "stop" === e || "quit" === e ? i._stop() : "ponderhit" === e && i._ponderhit(), i._origOnCustomMessage(e);
          }),
          {});
        ...
        X =
          (G
            ? ((p = l ? require("path").dirname(p) + "/" : __dirname + "/"),
              (Y = function (e, n) {
                return (q = q || require("fs")), (e = (W = W || require("path")).normalize(e)), q.readFileSync(e, n ? null : "utf8");
              }),
              (c = function (e) {
            ...
            : (B || l) &&
              (l ? (p = self.location.href) : "undefined" != typeof document && document.currentScript && (p = document.currentScript.src),
      ...
      (a = null), i.arguments && (N = i.arguments), i.thisProgram && (u = i.thisProgram), i.quit && (s = i.quit), i.wasmBinary && (f = i.wasmBinary);
      ...
      function K(e, n, t) {
        ...
        for (r = ""; n < t; ) {
          var o,
            a,
            i = e[n++];
          128 & i ? ((o = 63 & e[n++]), 192 == (224 & i) ? (r += String.fromCharCode(((31 & i) << 6) | o)) : ((a = 63 & e[n++]), (i = 224 == (240 & i) ? ((15 & i) << 12) | (o << 6) | a : ((7 & i) << 18) | (o << 12) | (a << 6) | (63 & e[n++])) < 65536 ? (r += String.fromCharCode(i)) : ((i -= 65536), (r += String.fromCharCode(55296 | (i >> 10), 56320 | (1023 & i)))))) : (r += String.fromCharCode(i));
        }
        return r;
      }
      function C(e) {
      ...
      function ie() {
        var e;
        v--, i.monitorRunDependencies && i.monitorRunDependencies(v), 0 == v && (null !== oe && (clearInterval(oe), (oe = null)), _) && ((e = _), (_ = null), e());
      }
      function w(e) {
        throw (i.onAbort && i.onAbort(e), d(e), (m = !0), (e = new WebAssembly.RuntimeError("abort(" + e + "). Build with -s ASSERTIONS=1 for more info.")), I(e), e);
      }
      function ue() {
      ...
      function b(e) {
        for (; 0 < e.length; ) {
          var n,
            t = e.shift();
          "function" == typeof t ? t(i) : "number" == typeof (n = t.U) ? (void 0 === t.S ? ke.call(null, n) : k.apply(null, [n, t.S])) : n(void 0 === t.S ? null : t.S);
        }
      }
      (i.preloadedImages = {}), (i.preloadedAudios = {}), (h = "stockfish-nnue-16-single.wasm"), ue() || (($ = h), (h = i.locateFile ? i.locateFile($, p) : p + $));
      var L,
        ce = [null, [], []],
        fe = {},
        le = G
      ...
      function de(r, t, o, a, n) {
        function i(e) {
          var n = 0,
            t = 0;
          e && ((t = w.response ? w.response.byteLength : 0), (n = j(t)), R.set(new Uint8Array(w.response), n)), (T[(r + 12) >> 2] = n), U(r + 16, t);
        }
        if ((d = T[(r + 8) >> 2])) {
          var e = C(d),
            u = (u = C((g = r + 112))) || "GET",
          ...
          if (((w.withCredentials = f), w.open(u, e, !s, l, p), s || (w.timeout = c), (w.Z = e), (w.responseType = "arraybuffer"), m && w.overrideMimeType(_), d)) for (; (u = T[d >> 2]) && (e = T[(d + 4) >> 2]); ) (d += 8), (u = C(u)), (e = C(e)), w.setRequestHeader(u, e);
          pe.push(w),
            (T[(r + 0) >> 2] = pe.length),
            ...
            (w.onload = function (e) {
              ...
              U(r + 24, 0), n && U(r + 32, n), (x[(r + 40) >> 1] = w.readyState), (x[(r + 42) >> 1] = w.status), w.statusText && O(w.statusText, R, r + 44, 64), 200 <= w.status && w.status < 300 ? t && t(r, w, e) : o && o(r, w, e);
            }),
            (w.onerror = function (e) {
              i(h);
              var n = w.status;
              U(r + 24, 0), U(r + 32, w.response ? w.response.byteLength : 0), (x[(r + 40) >> 1] = w.readyState), (x[(r + 42) >> 1] = n), o && o(r, w, e);
            }),
            ...
            (w.onprogress = function (e) {
              var n = h && v && w.response ? w.response.byteLength : 0,
                t = 0;
              h && v && ((t = j(n)), R.set(new Uint8Array(w.response), t)), (T[(r + 12) >> 2] = t), U(r + 16, n), U(r + 24, e.loaded - n), U(r + 32, e.total), (x[(r + 40) >> 1] = w.readyState), 3 <= w.readyState && 0 === w.status && 0 < e.loaded && (w.status = 200), (x[(r + 42) >> 1] = w.status), w.statusText && O(w.statusText, R, r + 44, 64), a && a(r, w, e), t && Ue(t);
            }),
        ...
        if (!m)
          if (n) e();
            ...
            try {
              ...
              if (!(e instanceof He) && "unwind" !== e) throw (e && "object" == typeof e && e.stack && d("exception thrown: " + [e, e.stack]), e);
            }
      }
      function me(n, e, t, r) {
        var o = L;
      ...
      function he() {
        if (!ye) {
          var e,
            n = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (("object" == typeof navigator && navigator.languages && navigator.languages[0]) || "C").replace("-", "_") + ".UTF-8", _: u || "./this.program" };
      ...
      function be(e, n, t, r) {
        ...
        for (c in (f = {
          ...
          "%U": function (e) {
            ...
            return i(t, (e = new Date(e.F + 1900, e.M, e.N))) < 0 ? a(Math.ceil((31 - t.getDate() + (ve(S(e.getFullYear()) ? E : _e, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === i(t, n) ? "01" : "00";
          },
          "%V": function (e) {
            ...
            return i(r, t) < 0 ? "53" : i(n, r) <= 0 ? "01" : a(Math.ceil((t.getFullYear() < e.F + 1900 ? e.R + 32 - t.getDate() : e.R + 1 - t.getDate()) / 7), 2);
          },
          "%w": function (e) {
            return e.P;
          },
        ...
        return (l = t), (p = Array(J(l) + 1)), O(l, p, 0, p.length), (c = p).length > n ? 0 : (y.set(c, e), c.length - 1);
      }
      function Se(e) {
        try {
          e();
              ...
              "function" == typeof n
                ? function () {
                    ...
                    try {
                      ...
                      m || (Me.pop() !== e && w("Assertion failed: undefined"), F && 1 === M && 0 === Me.length && ((M = 0), Se(i._asyncify_stop_unwind), "undefined" != typeof Fibers && Fibers.fa(), Ae) && (Ae(), (Ae = null)));
                    }
                  }
                : n;
          })(e);
      ...
      var Te,
              ...
              if (g) {
                ...
                try {
                  ...
                  (M.onsuccess = function (e) {
                    (e = e.target.result), (T[(b + 12) >> 2] = 0), U(b + 16, 0), U(b + 24, 0), U(b + 32, 0), (x[(b + 40) >> 1] = 4), (x[(b + 42) >> 1] = 200), O("OK", R, b + 44, 64), S(b, 0, e);
                  }),
              ...
              if (l) {
                ...
                try {
                  ...
                  (A.onsuccess = function (e) {
                    var n, t;
                    e.target.result ? ((n = (e = e.target.result).byteLength || e.length), (t = j(n)), R.set(new Uint8Array(e), t), (T[(F + 12) >> 2] = t), U(F + 16, n), U(F + 24, 0), U(F + 32, n), (x[(F + 40) >> 1] = 4), (x[(F + 42) >> 1] = 200), O("OK", R, F + 44, 64), D(F, 0, e)) : ((x[(F + 40) >> 1] = 4), (x[(F + 42) >> 1] = 404), O("Not Found", R, F + 44, 64), I(F, 0, "no data"));
                  }),
        ...
        Ue =
          (!(function () {
            function n(e) {
              (e = Re((e = e.exports))), (i.asm = e), (e = i.asm.w.buffer), (i.HEAP8 = y = new Int8Array(e)), (i.HEAP16 = new Int16Array(e)), (i.HEAP32 = g = new Int32Array(e)), (i.HEAPU8 = R = new Uint8Array(e)), (i.HEAPU16 = x = new Uint16Array(e)), (i.HEAPU32 = T = new Uint32Array(e)), (i.HEAPF32 = new Float32Array(e)), (i.HEAPF64 = new Float64Array(e)), ee.unshift(i.asm.x), ie();
            }
            function t(e) {
              n(e.instance);
            }
          ...
          if (!Te && ((Te = !0), (i.calledRun = !0), !m)) {
            if ((b(ee), b(ne), D(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), qe)) {
              ...
              try {
                ...
                e instanceof He || "unwind" == e || ((n = e) && "object" == typeof e && e.stack && (n = [e, e.stack]), d("exception thrown: " + n), s(1, e));
              }
            }
            if (i.postRun) for ("function" == typeof i.postRun && (i.postRun = [i.postRun]); i.postRun.length; ) (n = i.postRun.shift()), te.unshift(n);
            b(te);
          }
        }
        if (((a = a || N), !(0 < v))) {
          if (i.preRun) for ("function" == typeof i.preRun && (i.preRun = [i.preRun]); i.preRun.length; ) (n = void 0), (n = i.preRun.shift()), Z.unshift(n);
          b(Z),
            0 < v ||
              (i.setStatus
                ? (i.setStatus("Running..."),
    ...
    var We;
    (We = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0), "undefined" != typeof __filename && (We = We || __filename);
    return (
  ...
  ("undefined" != typeof self && "worker" === self.location.hash.split(",")[1]) ||
    ("undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process) && !require("worker_threads").isMainThread) ||
    (("undefined" != typeof onmessage && ("undefined" == typeof window || void 0 === window.document)) || ("undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process))
